        ...
        <div className="max-w-7xl mx-auto p-2 sm:p-6 lg:p-8">
            <header className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-accent p-4 rounded-lg shadow-sm">
                ...
                <div className="flex flex-col items-end text-right">
                    <span className="font-semibold text-lg text-accent-foreground">UltraCertify</span>
                    <p className="text-sm text-accent-foreground/80">IGBC's NEST PLUS Ver 1.0 - Green Home Certification</p>
                </div>
            </header>
