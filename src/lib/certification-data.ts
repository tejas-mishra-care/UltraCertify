...
const nestPlusCriteria: Criterion[] = [
  ...
  // Credit Criteria
  {
    ...
    type: 'Credit',
    requirements: 'Provide any two features mentioned below. For each feature two points (max 4 points for New, max 2 for Existing): 1. Courtyard 2. Vernacular materials 3. Local Vernacular Elements 4. Any other passive cooling/Heating system 5. Skylights',
  ...
  },
  {
    ...
    options: [
        { label: 'Bank/ ATM', points: 0 },
        { label: 'Saloon', points: 0 },
        { label: 'Bus stop / Railway station/ Metro station/ Auto stand', points: 0 },
        { label: 'Educational institutions (Pre-school, School, etc.,)', points: 0 },
        { label: 'Grocery store / Super market', points: 0 },
        { label: 'Stores such as clothes, electrical, stationary, milk booth, etc.,', points: 0 },
        { label: 'Laundry services', points: 0 },
        { label: 'Medical clinic/ Hospital / Pharmacy', points: 0 },
        { label: 'Park / Garden', points: 0 },
        { label: 'Place of Worship', points: 0 },
        { label: 'Playground / Totlot area', points: 0 },
        { label: 'Restaurant', points: 0 },
        { label: 'Refueling station for automobiles', points: 0 },
        { label: 'Sports club / Fitness center / Gym', points: 0 },
        { label: 'Theater / Mall', points: 0 },
    ]
  },
  {
    ...
    type: 'Credit',
    requirements: 'Provide vegetation on Ground/built-up structures: 30 sq.ft (1 Pt), 50 sq.ft (2 Pts), 75 sq.ft (3 Pts), 100 sq.ft (4 Pts). Note: Potted plants not considered. For Terrace, only permanent structures considered.',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Use atleast one bicycle for commuting purpose and provide dedicated parking space.',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Rainwater harvesting system to capture at least 750 Litres from site runoff (2 points) & Reuse provision for harvested water (2 points). Note: For an existing well or borewell the project shall be awarded 4 points.',
  ...
  },
  {
    ...
    options: {
      ...
      Existing: [
        ...
        { label: '8 Credits', points: 8 },
        { label: '9 Credits', points: 9 },
        { label: '10 Credits', points: 10 },
      ]
    }
  },
  {
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Provide the alternate (Solar/LPG/CNG) hotwater system having capacity to serve 100% of the occupants considering the 20 Litres/per day/Per person.',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Provide an electrical charging socket near to the vehicular parking area.',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: {
      New: 'Use Green certified/GreenPro Construction Materials: (1 point for each; maximum 7 points).',
      Existing: 'Use Green certified/GreenPro Construction Materials: (1 point for each; maximum 2 points).'
    },
    documents: 'Photos, cutsheets, and invoices.',
    points: { New: 7, Existing: 2 },
    options: {
        New: [
            { label: '1 Material', points: 1 },
            { label: '2 Materials', points: 2 },
            { label: '3 Materials', points: 3 },
            { label: '4 Materials', points: 4 },
            { label: '5 Materials', points: 5 },
            { label: '6 Materials', points: 6 },
            { label: '7 Materials', points: 7 },
        ],
        Existing: [
            { label: '1 Material', points: 1 },
            { label: '2 Materials', points: 2 },
  ...
  },
  {
    ...
    name: 'Ventilation',
    type: 'Credit',
    requirements: 'Provide openable windows that are 5% (1 pt), 7.5% (2 pts), or 10% (3 pts) of the total carpet area.',
    documents: 'Floor plans, photos, and calculation template.',
    points: 3,
    options: [
  ...
  },
  {
    ...
    name: 'Exhaust System',
    type: 'Credit',
    requirements: 'Provide exhaust systems in kitchen and bathrooms: Opening provision (1 pt) and Exhaust Fan (1 pt).',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Ensure two openings in each space: Living room/Kitchen (1 pt) and Each Room (1 pt, max 2 pts).',
  ...
  },
  {
    ...
    name: 'Exterior Views',
    type: 'Credit',
    requirements: 'Ensure direct line of sight to the outside from each space: Living room/Kitchen (1 pt) and Each Room (1 pt, max 2 pts).',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Install automation devices (1 pt each, max 3 for New, max 2 for Existing). Options: Lighting Controls, CCTV, Solar meter, Sensors, etc.',
  ...
  },
  {
    ...
    type: 'Credit',
    requirements: 'Support and Encourage the involvement of IGBC Accrediated Professional /AP Associate in the project.',
