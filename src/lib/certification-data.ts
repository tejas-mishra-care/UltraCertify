...
export const criteria: Criterion[] = [
  ...
  },
  {
    ...
    applicability: { New: true, Existing: true },
    type: 'Credit',
    requirements: 'Use of Green certified/GreenPro Construction Materials (1 point for each; maximum 7 points for New, 2 for Existing). Examples: Cement, RMC, Paints, Tiles, TMT Bars, Blocks, etc.',
